            ...
            <aside class="right-sidebar">
              ...
              <div class="widget">
                ...
                <ul class="contact-info">
                  <li><label>Address :</label>REGENCY ASSOCIATES<br> 01/306,Vijyant Khand,Gomti Nagar,<br>
Lucknow-226010</li>
                  <li><label>Phone :</label>9335003250, 9335909470, 9140782847</li>
                 <!--  <li><label>Fax : </label>+62 123 456 10 / +62 123 456 11</li> -->
                  <li><label>Email : </label> shailendraregency@gmail.com</li>
                </ul>
